        ...
        Rectangle {
            ...
            Column {
                ...
                BasicText {
                    ...
                    text: " <a href=\"https://www.goptics.com\">博仕科技有限公司 </a>>"
                    //"Author JaredTao <a href=\"https://jaredtao.github.io\">JaredTao Blog</a>"
                    onLinkActivated: {
                        Qt.openUrlExternally("https://www.goptics.com")
                    }
                    TransArea {
            ...
            Row {
                ...
                spacing: 20
                BasicText {
                    text: qsTr("关注公众号:") + trans.transString
                    anchors.verticalCenter: parent.verticalCenter
                }
                CusImage {
                    source: imgPath + "Tao/pubWeixin2D.png"

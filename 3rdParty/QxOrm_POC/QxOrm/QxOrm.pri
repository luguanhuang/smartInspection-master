...
# jiayi: oct.18,2022:  must commented these lines in order that trahnslation_poc pri work
#这个地方设置这些参数后会把路径换地方了，导致系统生成的trahnslation_poc pri  翻译库找不到了……
QT += sql
